...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `
      ...
      هام جداً: يجب أن تكون جميع القيم (values) في ملف JSON باللغة "العربية البيضاء" حصراً.
      ...
      {
        "problem": "وصف دقيق للمشكلة التي يعالجها المنتج بالعربية",
        ...
        "product_name": "اسم المنتج المستخلص بالعربية"
      }
