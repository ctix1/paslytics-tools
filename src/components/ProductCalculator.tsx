      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-1 space-y-6">
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-6 shadow-2xl">
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block">{t('pc_marketing_budget')}</label>
              <input 
                type="number" 
        ...
        <div className="xl:col-span-2 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Price Result */}
            <div className="glass-panel p-10 relative overflow-hidden group bg-slate-900/40">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-6xl font-black text-white tracking-tighter">${calculations.finalPrice.toFixed(2)}</span>
            ...
            {/* Risk Assessment */}
            <div className="glass-panel p-10 flex flex-col justify-between bg-slate-900/40">
              <div>
          ...
          {/* Suggestions List */}
          <div className="glass-panel p-8 border-none bg-gradient-to-br from-white/5 to-white/[0.01]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {suggestions.map((suggestion, i) => (
                <motion.div 
                  ...
                  className="p-4 bg-slate-950/40 border border-white/5 rounded-2xl flex gap-4 hover:border-blue-500/30 transition-all group"
                >
                  ...
                  <p className="text-slate-300 font-medium leading-relaxed m-0 text-xs">
                    {suggestion}
                  </p>
                </motion.div>
              ))}
